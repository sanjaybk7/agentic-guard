...
- **17 tests collected, 14 FAIL (assertion), 3 PASS, 0 ERRORS**
- Passing tests: `test_no_crewai_import_not_detected`, `test_sources_only_crewai_no_ig001`,
  `test_sinks_only_crewai_no_ig001` — negative/precision guards pass vacuously on the red half.
